...
(function () {
  ...
  const dict = {
    en: {
      ...
      't.weston2': '"Today’s experience was really great — I went back and revised a whole batch of recently-published pieces. Goes to show: my ability as an author may be limited, but my readers’ taste is on point. ✌"',
      't.weston3': '"The reader-feedback reports are fascinating — I’m still working up the nerve to swallow them whole. As a writing newbie, the Kindle data makes me want to chase a perfect score. The editor’s notes feel honest — readers can be brutal."',
      't.weston4': '"Love this — reminds me of the early Notion AI days, but the suggestions actually keep my voice."',
      't.tim1':    '"The software is very easy to use and the core concept is excellent. I use it as a writer’s writing studio, and I’ve also used the reader test-reading feature. Overall the experience is very smooth — it’s been a huge help."',
      't.tim2':    '"A great source of inspiration — then I polish it into a tone that fits me better."',
    ...
    zh: {
      ...
      't.weston2': '「今天使用上的體感真的好棒，我把近期發表的文章改了一輪。顯示我身為作者能力有限，但讀者的審美在線。✌」',
      't.weston3': '「讀者回饋的報告很有趣，但我還在努力說服自己吞下去 XDD。Kindle 數據表現也好好玩（身為寫作小白，會有種想挑戰滿分的衝動）。編輯來信給的回饋蠻中肯的 — 不像讀者都很賤。」',
      't.weston4': '「好喜歡這個，想到之前的 Notion AI — 但 Slima 的建議真的不會把我的語氣帶偏。」',
      't.tim1':    '「這套軟體非常好上手，核心概念也很棒。我把它當作寫作工作室，也用過讀者試讀的功能。整體體驗非常順暢 — 真的幫了大忙。」',
      't.tim2':    '「是一個很不錯的靈感來源 — 然後再潤飾成更適合自己的語氣。」',
      't.weston.name': '魏斯頓',
